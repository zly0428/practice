...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			float totaltime = endtime/(float)1000000000.0 - starttime/(float)1000000000.0;
			System.out.printf("%9.2f\t",totaltime);
			
			long starttimeEf = System.nanoTime();
			for ( int i = 0; i < trials; i ++) {
				EfficientDocument efficient = new EfficientDocument(s);
				efficient.getFleschScore();
			}
			long endtimeEf = System.nanoTime();
			float totaltimeEf = endtimeEf/(float)1000000000.0 - starttimeEf/(float)1000000000.0;
			System.out.printf("%9.2f\t",totaltimeEf);
