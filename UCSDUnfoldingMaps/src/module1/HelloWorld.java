...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		this.background(255, 221, 0);

		// Select a map provider
		AbstractMapProvider provider = new Google.GoogleTerrainProvider();
		AbstractMapProvider providerMap2 = new Google.GoogleMapProvider();
		// Set a zoom level
		int zoomLevel = 10;
	    ...
	    map1.zoomAndPanTo(zoomLevel, new Location(43.46f, -80.58f));
		
		// This line makes the map interactive
		MapUtils.createDefaultEventDispatcher(this, map1);
		
		// TODO: Add code here that creates map2 
		map2 = new UnfoldingMap(this, 420, 50, 350, 500, providerMap2);
		map2.zoomAndPanTo(zoomLevel, new Location(39.96f,116.36));
